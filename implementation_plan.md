...
**[사용자 입력]** 각 기업 자소서 문항(또는 '사람인 지원' 여부), 글자 수, 반영 희망 에피소드  
**[AI 수행]** 지원 방식(사람인 고정 3개 항목 vs 개별 기업 자체 문항)에 따라 분기하여, STAR 기법 및 문체 가이드 적용 후 `[기업명]/[기업명]_Cover_Letter_Draft.md` 초안 작성.
